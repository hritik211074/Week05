...
class ReadJsonData {
    public static void main(String[] args) {
        try {
            ...
            String content = new String(Files.readAllBytes(Paths.get("D:\\Training_Assessment_Week_05\\src\\main\\java\\org\\example\\com\\day02_jason\\practice_problems\\Person.Json")));
